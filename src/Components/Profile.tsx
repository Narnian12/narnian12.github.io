...
function Profile() {
  return (
    <CardLayout>
      <Card>
        <h2>Introduction</h2>
        <CardText>Hello! I'm Peter, an aspiring full-stack developer with experience in 
      ...
      <Card>
        <h2>Work</h2>
        <CardText>I am a software engineer in Promess, a manufacturing company specializing
      ...
      <Card>
        <h2>Education</h2>
        <CardText>I am pursuing a Master of Science in Computer Science at Oakland University.
      ...
      <Card>
        <h2>Passions</h2>
        <CardText>I enjoy writing. I love writing prose and poetry, and hope to publish a novel one day. I also like playing guitar and piano.
      ...
      <Card>
        ...
        <CardText>I am working and researching with Rust, React, GraphQL, Node.js, and Java.
