...
function Profile() {
  return (
    <div className="Profile">
      <div className="card">
        <h2>Introduction</h2>
        <p className="pro_desc">Hello! I'm Peter, an aspiring full-stack developer with experience in 
      ...
      <div className="card">
        <h2>Work</h2>
        <p className="pro_desc">I am a software engineer in Promess, a manufacturing company specializing
      ...
      <div className="card">
        <h2>Education</h2>
        <p className="pro_desc">I am pursuing a Master of Science in Computer Science at Oakland University.
      ...
      <div className="card">
        <h2>Research</h2>
        <p className="pro_desc">I hope to complete a Master's Thesis during my graduate studies. I am working on analyzing Dependency Injection (DI),
      ...
      <div className="card">
        <h2>Passions</h2>
        <p className="pro_desc">I enjoy writing. One of my favorite features of the Rust language is its robust
      ...
      <div className="card">
        <h2>Fun Facts</h2>
        <p className="pro_desc">I have two gerbils. I studied microbiology during my undergraduate years. I love broccoli.</p>
      </div>
    </div>
  );
}
